package com.rangganf.storyappearly.ui.main.liststory
...
import com.rangganf.storyappearly.databinding.ListStoriesBinding
...
class StoriesAdapter(private val callback: (story: Story, imageView: View, nameView: View, descView: View) -> Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StoriesViewHolder {
        val view = ListStoriesBinding.inflate(LayoutInflater.from(parent.context), parent, false)
...
class StoriesViewHolder(val view: ListStoriesBinding) : RecyclerView.ViewHolder(view.root) {
    fun bind(item: Story) {
        view.story = item
